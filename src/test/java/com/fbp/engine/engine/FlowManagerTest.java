...
class FlowManagerTest {
        ...
        String json = """
            {
              ...
              "name": "test-flow",
              "description": "sample",
              "nodes": [{"id": "n1", "type": "MockType", "config": {}}],
              "connections": []
            }
            """;
    ...
    void test2_List() {
        String json1 = "{\"id\":\"f1\", \"nodes\":[{\"id\":\"n1\",\"type\":\"MockType\"}], \"connections\":[]}";
        String json2 = "{\"id\":\"f2\", \"nodes\":[{\"id\":\"n2\",\"type\":\"MockType\"}], \"connections\":[]}";
    ...
    void test10_UnknownNodeType() {
        String json = "{\"id\":\"f1\", \"nodes\":[{\"id\":\"n1\",\"type\":\"UnknownType\"}], \"connections\":[]}";
